...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    the_ones_player = player_score % 10
    the_tens_opponent = opponent_score / 10
    difference = 3 * abs(the_ones_player - the_tens_opponent)
...
def play(strategy0, strategy1, update,
    ...
    if score0 <= goal and score1 <= goal:
        ...
        if score0 <= goal:
            score1 = update(strategy1, score1, score0, dice)
